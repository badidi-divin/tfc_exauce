		...
		<div class="main-container">
			<div class="xs-pd-20-10 pd-ltr-20">
				<div class="title pb-20">
					<h2 class="h3 mb-0">Bienvenue au Tableau de Bord</h2>
				</div>
				...
				<div class="row pb-10">
						...
						<div class="card-box height-100-p widget-style3">
							<div class="d-flex flex-wrap">
								<div class="widget-data">
									<div class="weight-700 font-24 text-dark"><?php $nblmd=$pdo->prepare('SELECT * FROM eleve');
									$nblmd->execute();
									$nblmd=$nblmd->fetchAll();
									echo count($nblmd); ?></div>
					...
					<div class="col-xl-3 col-lg-3 col-md-6 mb-20">
						<div class="card-box height-100-p widget-style3">
							<div class="d-flex flex-wrap">
								<div class="widget-data">
									<div class="weight-700 font-24 text-dark"><?php $nblmd=$pdo->prepare('SELECT * FROM eleve WHERE montant>0');
									$nblmd->execute();
									$nblmd=$nblmd->fetchAll();
									echo count($nblmd); ?></div>
									<div class="font-14 text-secondary weight-500">
										Les élèves qui ne sont pas en ordre
									</div>
								</div>
								<div class="widget-icon">
									<div class="icon">
