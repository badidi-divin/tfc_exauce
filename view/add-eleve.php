<?php require_once('../bdd/connexion.php');
	  require_once('../model/insert-eleve.php');
 ?>
<!DOCTYPE html>
<html>
	<head>
					...
					<div class="col-md-6 col-lg-5">
						<div class="login-box bg-white box-shadow border-radius-10">
							<div class="login-title">
								<h2 class="text-center text-primary">Ajout Elève</h2>
							</div>
							<form method="post" action="">
								<div class="form-group">
									...
									<input
										...
										placeholder="Code Elève" name="code_eleve"
									/>
								</div>
								<div class="form-group">
									...
									<input
										type="text"
										class="form-control form-control-lg"
										placeholder="Nom de l'élève" name="nom"
									/>
								</div>
								<div class="form-group">
									...
									<input
										type="text"
										class="form-control form-control-lg"
										placeholder="Post-Nom de l'élève" name="postnom"
									/>
								</div>
								<div class="form-group">
									...
									<input
										type="text"
										class="form-control form-control-lg"
										placeholder="Prenom de l'élève" name="prenom"
									/>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									...
									<input
										type="number"
										class="form-control form-control-lg"
										placeholder="Numéro de Telephone" name="tel"
									/>
								</div>
								<div class="form-group">
									...
									<input
										type="text"
										class="form-control form-control-lg"
										placeholder="Adresse Complète" name="adresse"
									/>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									...
									<input
										type="text"
										class="form-control form-control-lg"
										placeholder="annee_scolaire" name="annee_scolaire"
									/>
								</div>
								<div class="row">
									<div class="col-sm-12">
